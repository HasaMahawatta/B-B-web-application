...
if(isset($_POST['cmt_btn']))
  {
    $lodge = $_POST['Lodge'];
	 ...
	 if(mysqli_query($con,"INSERT INTO `comment`(`id`,`Lodge`,`Comment`) VALUES (NULL,'$lodge','$message')"))
		 {
		   header("location:?s=1");
...
<body>
  <div id="wrapper">
	...
	<div id="body">
       ...
       <div id="reg"><h1><span>Please Leave a comment</span></h1></div>
        <p>&nbsp;</p>
  ...
  <tbody>
    <tr>
      ...
      <tr>
      <td>Lodge Name</td>
    <td><input type ="text" id="text" placeholder="lodge name" name="Lodge"></td>
    </tr>
    <tr>
  <td>Comment</td>
    <td><textarea name="Message" id"message" placeholder="Your comment worth a lot..." ></textarea></td>
    </tr>
    <tr>
    <td></td>
    <td><input name="cmt_btn" type="submit" value="Enter"></td>
    </tr>
  </tbody>
</table>
 ...
 if(isset($_GET['s']))
  {
	  echo "<script>swal('Congratulations!','You Have Successfully leave a comment!','success')</script>";
  }
 ?>
  <?php
 if(isset($_GET['e']))
