...
<div class="wrapper">
      ...
      <nav class="navbar navbar-default navbar-fixed-top" style="background: #ffffff;border-bottom: 4px solid #000000 ;"> 
            ...
            <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-6" aria-expanded="false" style="height: 1px;"> 
                <ul class="nav navbar-nav navbar-right"> 
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bell" aria-hidden="true"></i> <span class="caret"></span></a>
                     ...
                     <li><a href="#"  data-toggle="exampleModal"><button data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="padding: 0;border: none; background: none;" type="button">Lodge added</button></a></li>
                     <li><a href="#"  data-toggle="exampleModal"><button data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="padding: 0;border: none; background: none;" type="button">Lodge added</button></a></li>
                     </ul>
                    </li>
                    ...
                    <li><a href="#"><img src="assets\img\avatar-1.jpg" width="25px" height="25px" class="header-avatar img-circle ml10" alt="user" title="user"> User Name</a></li> 
                    <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs" aria-hidden="true"></i> <span class="caret"></span></a>
                     <ul class="dropdown-menu">
                     <li><a href="#"  data-toggle="exampleModal"><button data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="padding: 0;border: none; background: none;" type="button">Change Password</button></a></li>
      ...
      <div class="container">
        <div class="row" style="margin-right: -28px; margin-left: -28px;">
          <div class="col-md-12" style="background-color: #ffffff;  margin-bottom: 20px;" >
            <form  class="form-wizzard form-horizontal" action="addlodge.php" method="post">
              ...
              <div class="row">
                <div class="col-md-6" style="padding: 0 30px">
                  ...
                  <div class="form-group">
                    <label>Title</label>
                    <input class="form-control" type="text" name="title" placeholder="Enter Property Title ..."/>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="selectcat">
                     ...
                     <div class="col-md-4" style="margin-left: -14px; width: 569px; ">
                     <label style="margin-left: -13px;">Description</label>
                      <div class="text_cont form-group floating-label-form-group controls">
                        <textarea id="msg" name="description"  rows="5" placeholder="Message" type="text" class="form-control"></textarea><span class="help-block text-danger"></span>
                        <div id="success"></div>
                      </div>
                    </div>
                ...
                <div class="col-md-6" style="padding: 0 30px">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="img" type="file" placeholder="Add Images: ..."/>
              ...
              <div class="wizzard-confirm" style="padding-bottom:  85px; padding-left :490px; padding-top: 30px;">
                ...
                <button class="btn btn-success btn-lg" style="width: 170px; background-color:#9CCC65;" name="addlodge_btn">Submit</button>
              </div>
            </form>
          </div>
        </div>
